...
import torch
from layer.sublayer import PositionwiseFeedForward, MultiHeadedAttention


class RGATLayer(nn.Module):
    def __init__(
        self, d_model, heads, d_ff, dropout, att_drop=0.1,
        use_structure=True, dep_dim=30, alpha=1.0, beta=1.0
    ):
    ...
    """
        ...
        for i in range(self.num_layers):
            out = self.transformer[i](
                out, mask, src_key_padding_mask, structure=structure
            )
